...
export default function ContentSection2() {
    ...
    return (
        <section className="flex justify-between px-[30px] w-[1220px] h-[212px] mt-[180px] mx-auto">
            <h2 className="flex w-[460px] h-[114px] text-[32px] font-bold line-h2">Дополнительные источники выручки для разных компаний</h2>
            <div  className='w-[560px] h-[188px]'>
                { isToggled ? 
                    <article className='flex w-[560px] h-[60px] bg-white rounded-[10px] justify-around items-center'>
